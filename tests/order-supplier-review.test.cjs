...
assert.match(app, /id="supplier-review-tabs"/);
assert.match(app, /activeSupplierReviewKey/);
assert.match(app, /function switchSupplierReviewTab\(key\)/);
assert.match(app, /single-supplier/);
